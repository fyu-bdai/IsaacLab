...
class ArticulationData:
    ...
    def __init__(self, root_physx_view: physx.ArticulationView, device: str):
        ...
        self._body_joint_reaction_wrench_b = TimestampedBuffer()
    ...
    def body_joint_reaction_wrench_b(self) -> torch.Tensor:
        ...
        if self._body_joint_reaction_wrench_b.timestamp < self._sim_timestamp:
            self._body_joint_reaction_wrench_b.data = self._root_physx_view.get_link_incoming_joint_force()
            self._body_joint_reaction_wrench_b.time_stamp = self._sim_timestamp
        return self._body_joint_reaction_wrench_b.data
